...
execute unless items entity @s armor.chest * run item replace entity @s armor.chest with barrier[custom_data={"sand.placeholder":true},equippable={slot:"chest"}]
execute unless items entity @s armor.legs * run item replace entity @s armor.legs with barrier[custom_data={"sand.placeholder":true},equippable={slot:"legs"}]
execute unless items entity @s armor.feet * run item replace entity @s armor.feet with barrier[custom_data={"sand.placeholder":true},equippable={slot:"feet"}]
