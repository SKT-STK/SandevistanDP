execute if items entity @s weapon.mainhand #sand:make_consumable[!minecraft:consumable] run item modify entity @s weapon.mainhand {'function': 'minecraft:set_components', 'components': {'consumable': {'consume_seconds': 2147483647}}}
